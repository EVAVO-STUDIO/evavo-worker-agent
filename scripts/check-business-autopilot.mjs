...
const required = {
  ...
  'src/index.ts': ['handleBusinessAutopilotAdmin', 'handleBusinessAutopilotWebsiteAdmin', 'pathname === "/admin/business/websites" || pathname === "/admin/business/pages"', 'pathname === "/admin/business" || pathname.startsWith("/admin/business/")'],
  ...
  'scripts/check-business-autopilot.mjs': ['Business Autopilot foundation check passed.', 'src/core/businessAutopilotSafety.ts', 'src/core/businessAutopilotTypes.ts', 'src/core/businessAutopilotRecords.ts', 'src/core/businessAutopilotServiceMatcher.ts', 'src/core/businessAutopilotOpportunityScoring.ts', 'src/core/businessAutopilotAuditPacks.ts', 'src/core/businessAutopilotActionDraftBuilder.ts', 'src/core/businessAutopilotApprovalBuilder.ts', 'src/core/businessAutopilotDraftReviewBundle.ts', 'src/core/businessAutopilotWebsiteRecords.ts', 'src/routes/businessAutopilotWebsiteAdmin.ts', 'docs/business-autopilot-draft-review-route-plan.md', 'docs/business-autopilot-validation.md', 'scripts/print-business-autopilot-readonly-verify-commands.mjs', 'src/core/businessAutopilotAuditPackRecords.ts', 'src/routes/businessAutopilotAdmin.ts', 'src/routes/businessAutopilotRouteCatalogue.ts', 'scripts/print-business-autopilot-route-contract-check.mjs', '0021_business_autopilot_foundation.sql'],
