...
const required = {
  ...
  'scripts/check-business-autopilot.mjs': ['Business Autopilot foundation check passed.', 'src/core/businessAutopilotSafety.ts', 'src/core/businessAutopilotTypes.ts', 'src/core/businessAutopilotRecords.ts', 'src/core/businessAutopilotServiceMatcher.ts', 'src/core/businessAutopilotOpportunityScoring.ts', 'src/core/businessAutopilotAuditPacks.ts', 'src/core/businessAutopilotActionDraftBuilder.ts', 'src/core/businessAutopilotApprovalBuilder.ts', 'src/core/businessAutopilotDraftReviewBundle.ts', 'docs/business-autopilot-draft-review-route-plan.md', 'scripts/print-business-autopilot-readonly-verify-commands.mjs', 'src/core/businessAutopilotAuditPackRecords.ts', 'src/routes/businessAutopilotAdmin.ts', 'src/routes/businessAutopilotRouteCatalogue.ts', 'scripts/print-business-autopilot-route-contract-check.mjs', '0021_business_autopilot_foundation.sql'],
  ...
  'package.json': ['business:autopilot:check', 'node scripts/check-business-autopilot.mjs', 'node scripts/apply-business-autopilot-route-catalogue.mjs'],
};
