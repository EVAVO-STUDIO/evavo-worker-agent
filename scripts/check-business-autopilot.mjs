...
const required = {
  ...
  'src/routes/businessAutopilotAdmin.ts': ['handleBusinessAutopilotAdmin', 'Business Autopilot writes require confirmation', '0021_business_autopilot_foundation.sql', '/admin/business/organizations', '/admin/business/signals', '/admin/business/opportunities', '/admin/business/service-matches', '/admin/business/audit-packs', '/admin/business/action-drafts', '/admin/business/approval-requests', '/admin/business/suppression', '/admin/business/content-ideas', '/admin/business/followups', '/admin/business/learning', 'listBusinessAuditPacks', 'saveBusinessAuditPack', ...readRouteIds],
  ...
  'scripts/check-business-autopilot.mjs': ['Business Autopilot foundation check passed.', 'src/core/businessAutopilotSafety.ts', 'src/core/businessAutopilotTypes.ts', 'src/core/businessAutopilotRecords.ts', 'src/core/businessAutopilotServiceMatcher.ts', 'src/core/businessAutopilotOpportunityScoring.ts', 'src/core/businessAutopilotAuditPacks.ts', 'src/core/businessAutopilotAuditPackRecords.ts', 'src/routes/businessAutopilotAdmin.ts', 'src/routes/businessAutopilotRouteCatalogue.ts', 'scripts/print-business-autopilot-route-contract-check.mjs', '0021_business_autopilot_foundation.sql'],
