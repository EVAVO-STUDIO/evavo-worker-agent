...
const requiredTokens = {
  ...
  'Run-WorkerFinalGate.ps1': ['EVAVO Worker final local gate', 'does not run migrations', 'npm run scripts:check', 'npm run growth:backend:check:local', 'npm run growth:generated-routes:check', 'npm run db:verify:print', 'npm run deploy'],
