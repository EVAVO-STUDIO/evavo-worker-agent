...
addImport('import { handleGrowthBlackboardAdmin } from "./routes/growthBlackboardAdmin";', 'import { handleGrowthStrategyMemoryAdmin } from "./routes/growthStrategyMemoryAdmin";');
...
addRoute('      if (pathname === "/admin/growth/blackboard" || pathname === "/admin/growth/blackboard/facts" || pathname === "/admin/growth/blackboard/entities" || pathname === "/admin/growth/blackboard/relationships" || pathname === "/admin/growth/blackboard/signals" || pathname === "/admin/growth/blackboard/assets") return await handleGrowthBlackboardAdmin(req, env, pathname, jsonResponse);', genericGrowthRoute);
