...
const required = {
  'README.md': ['EVAVO Business Autopilot', 'Business Autopilot summary', 'Business Autopilot validation commands', 'metadata-only agency intelligence', 'business_action_draft_build', 'business:autopilot:readonly:print', 'business:route-contract:print', 'docs/business-autopilot-validation.md', 'no third-party commenting', 'no contact-form submission', 'no browser execution', 'no external mutation'],
