...
requireTokens("review mutation boundary document", doc, [
  ...
  "`public_research_fetch_v2` URL-admission policy",
  "one parameterised D1 `WHERE url IN (...)` query",
  "Validation does not fetch the URL.",
  "all accepted `opportunity_sources` inserts",
  "do not call AI",
  "do not send email",
...
console.log(JSON.stringify({
  ...
  sourceCandidatePublicUrlPolicyRequired: true,
  sourceCandidateMetadataLookupBatched: true,
