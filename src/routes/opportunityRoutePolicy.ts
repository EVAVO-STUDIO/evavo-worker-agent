...
const policyDefinitions = [
  ...
  { id: "source-health-action", priority: 30, authentication: "handler-enforced", mutationPosture: "mixed-internal", confirmation: "handler-enforced", networkPosture: "handler-defined", canSendEmail: false, canPostSocial: false, canSubmitForms: false, matches: (pathname: string) => /^\/admin\/opportunities\/sources\/[^/]+\/health-action$/.test(pathname) },
