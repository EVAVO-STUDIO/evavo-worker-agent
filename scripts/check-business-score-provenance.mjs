...
requireTokens("Account dimension evidence executable test", sources.dimensionEvidenceTest, [
  ...
  "dimension keyword matching respects token boundaries",
...
console.log(JSON.stringify({
  ...
  contract: "business-score-provenance-v5-token-safe-account-dimensions",
  ...
  accountDimensionKeywordBoundariesEnforced: true,
  missingDimensionsRemainUnknown: true,
