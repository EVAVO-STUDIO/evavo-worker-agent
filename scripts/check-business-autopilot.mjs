...
const required = {
  ...
  'migrations/0022_business_website_audit_records.sql': ['Business website audit metadata records', ...websiteAuditTables.map((table) => `CREATE TABLE IF NOT EXISTS ${table}`)],
  ...
  'scripts/check-business-autopilot.mjs': ['Business Autopilot foundation check passed.', 'business_audit_observation_candidates', 'src/core/businessAutopilotAuditObservationCandidates.ts'],
