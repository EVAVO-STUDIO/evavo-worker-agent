...
const required = {
  ...
  'src/core/businessAutopilotActionDraftBuilder.ts': ['BusinessDraftBuildIntent', 'BusinessDraftBuildInput', 'buildBusinessDraftOnlyAction', 'draft_only', 'approval_required', 'suppression_check_required', 'contactability_check_required', 'Do not send email from this route.', 'Do not post on social platforms from this route.', 'Do not submit contact forms from this route.', 'handleBusinessAutopilotAdmin'],
