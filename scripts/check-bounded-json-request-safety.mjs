...
for (const [label, source, tokens] of [
  ...
  ["autonomy settings bounded body", read("src/routes/autonomySettingsAdmin.ts"), [
  ...
  ["legacy settings bounded body", read("src/routes/legacyExecutionSafetyAdmin.ts"), [
  ...
  ["legacy draft review bounded body", read("src/routes/legacyExecutionSafetyAdmin.ts"), [
...
console.log(JSON.stringify({
  ...
  previous_contract: "bounded-admin-json-request-safety-v3-protected-admin",
  legacy_contract: "bounded-admin-json-request-safety-v2-review-mutations",
