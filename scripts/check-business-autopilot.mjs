...
const required = {
  ...
  'src/core/businessAutopilotServiceMatcher.ts': [
    'BusinessServiceMatchSuggestion',
    'listEvavoServiceDefinitions',
    'matchEvavoServicesFromSignals',
    'primaryServiceFromSignals',
    'website_rebuild',
    'ux_ui',
    'analytics_seo',
    'ai_chatbot',
  ...
  'src/core/businessAutopilotOpportunityScoring.ts': [
    'BusinessOpportunityScoreInput',
    ...
    'recommendedService',
    'recommendedAngle',
    'Prepare an evidence-backed audit pack',
  ],
