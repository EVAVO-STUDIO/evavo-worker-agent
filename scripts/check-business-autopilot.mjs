...
const required = {
  ...
  'docs/business-autopilot-validation.md': ['Business Autopilot validation workflow', 'npm run business:autopilot:check', 'npm run business:route-contract:print', 'npm run business:autopilot:readonly:print', 'business_action_draft_build', 'business_audit_packs', 'safety.readOnly: true', 'safety.internalMetadataOnly: true', 'does not perform external execution'],
  ...
  'src/routes/businessAutopilotAdmin.ts': ['handleBusinessAutopilotAdmin', 'buildBusinessDraftOnlyAction', 'business_action_draft_built', 'Business Autopilot writes require confirmation', '0021_business_autopilot_foundation.sql', '/admin/business/organizations', '/admin/business/signals', '/admin/business/opportunities', '/admin/business/service-matches', '/admin/business/audit-packs', '/admin/business/action-drafts/build', '/admin/business/action-drafts', '/admin/business/approval-requests', '/admin/business/suppression', '/admin/business/content-ideas', '/admin/business/followups', '/admin/business/learning', 'listBusinessAuditPacks', 'saveBusinessAuditPack', ...readRouteIds],
  'src/index.ts': ['handleBusinessAutopilotAdmin', 'pathname === "/admin/business" || pathname.startsWith("/admin/business/")'],
  ...
  'scripts/print-business-autopilot-route-contract-check.mjs': ['EVAVO Business Autopilot route-contract smoke check', 'Business Autopilot route contract is valid.', ...readRouteIds, ...confirmRouteIds, '/admin/business/organizations?limit=5', '/admin/business/audit-packs?limit=5', '/admin/business/learning?limit=5', 'Business Autopilot route has missing or unsafe read safety', 'does not send, post, comment, submit forms, call AI, browse, buy ads, execute browser actions, or mutate external systems'],
  'scripts/print-business-autopilot-readonly-verify-commands.mjs': ['EVAVO Business Autopilot read-only verification', 'Assert-BusinessRead', '/admin/business/organizations?limit=5', '/admin/business/audit-packs?limit=5', '/admin/business/learning?limit=5', 'Business Autopilot read-only verification complete.', 'does not send, post, comment, submit forms, call AI, browse, buy ads, execute browser actions, or mutate external systems'],
  'scripts/check-business-autopilot.mjs': ['Business Autopilot foundation check passed.', 'src/core/businessAutopilotSafety.ts', 'src/core/businessAutopilotTypes.ts', 'src/core/businessAutopilotRecords.ts', 'src/core/businessAutopilotServiceMatcher.ts', 'src/core/businessAutopilotOpportunityScoring.ts', 'src/core/businessAutopilotAuditPacks.ts', 'src/core/businessAutopilotActionDraftBuilder.ts', 'src/core/businessAutopilotApprovalBuilder.ts', 'src/core/businessAutopilotDraftReviewBundle.ts', 'docs/business-autopilot-draft-review-route-plan.md', 'docs/business-autopilot-validation.md', 'scripts/print-business-autopilot-readonly-verify-commands.mjs', 'src/core/businessAutopilotAuditPackRecords.ts', 'src/routes/businessAutopilotAdmin.ts', 'src/routes/businessAutopilotRouteCatalogue.ts', 'scripts/print-business-autopilot-route-contract-check.mjs', '0021_business_autopilot_foundation.sql'],
