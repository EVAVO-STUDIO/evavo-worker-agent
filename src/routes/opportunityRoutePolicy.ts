...
const policyDefinitions = [
  ...
  { id: "runs", priority: 20, authentication: "handler-enforced", mutationPosture: "read-only", confirmation: "not-required", networkPosture: "none", canSendEmail: false, canPostSocial: false, canSubmitForms: false, matches: (pathname: string) => pathname === "/admin/opportunities/runs" || pathname.startsWith("/admin/opportunities/runs/") },
  { id: "source-health-action", priority: 30, authentication: "handler-enforced", mutationPosture: "mixed-internal", confirmation: "handler-enforced", networkPosture: "none", canSendEmail: false, canPostSocial: false, canSubmitForms: false, matches: (pathname: string) => /^\/admin\/opportunities\/sources\/[^/]+\/health-action$/.test(pathname) },
  ...
  { id: "source-expansion", priority: 80, authentication: "handler-enforced", mutationPosture: "mixed-internal", confirmation: "handler-enforced", networkPosture: "handler-defined", canSendEmail: false, canPostSocial: false, canSubmitForms: false, matches: (pathname: string) => pathname.startsWith("/admin/opportunities/sources/expansion/") },
  ...
  { id: "discovery", priority: 120, authentication: "handler-enforced", mutationPosture: "mixed-internal", confirmation: "handler-enforced", networkPosture: "read-only-research", canSendEmail: false, canPostSocial: false, canSubmitForms: false, matches: (pathname: string) => pathname.startsWith("/admin/opportunities/sources/") && (pathname.endsWith("/test") || pathname.endsWith("/preview") || pathname.endsWith("/commit-preview")) },
  { id: "learning", priority: 130, authentication: "handler-enforced", mutationPosture: "read-only", confirmation: "not-required", networkPosture: "none", canSendEmail: false, canPostSocial: false, canSubmitForms: false, matches: exact(["/admin/opportunities/learning"]) },
  { id: "review", priority: 140, authentication: "handler-enforced", mutationPosture: "mixed-internal", confirmation: "handler-enforced", networkPosture: "none", canSendEmail: false, canPostSocial: false, canSubmitForms: false, matches: (pathname: string) => pathname === "/admin/opportunities/reviews" || pathname === "/admin/opportunities/strategy-scores" || (pathname.startsWith("/admin/opportunities/") && pathname.endsWith("/review")) },
  { id: "opportunities-fallback", priority: 150, authentication: "handler-enforced", mutationPosture: "mixed-internal", confirmation: "handler-enforced", networkPosture: "handler-defined", canSendEmail: false, canPostSocial: false, canSubmitForms: false, matches: (pathname: string) => pathname.startsWith("/admin/opportunities") },
] satisfies readonly OpportunityRoutePolicy[];

export const OPPORTUNITY_ROUTE_POLICIES: readonly OpportunityRoutePolicy[] = Object.freeze(
  policyDefinitions.map((policy) => Object.freeze(policy)),
);

export function resolveOpportunityRouteHandlerId(pathname: string): OpportunityRouteHandlerId | null {
  return OPPORTUNITY_ROUTE_POLICIES.find((policy) => policy.matches(pathname))?.id ?? null;
}
