...
console.log(JSON.stringify({
  ...
  contract: "review-first-runtime-capability-configuration-v4-strict-public-fetch",
  ...
  strictPublicSubrequestsEnabled: wrangler.includes('compatibility_flags = ["global_fetch_strictly_public"]'),
