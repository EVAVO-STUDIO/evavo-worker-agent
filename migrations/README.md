...
- `0022_business_website_audit_records.sql` creates Business website/funnel audit metadata: website audit run and audit observation metadata tables. It is schema-only and does not enable crawling, fetching, sending, posting, contact-form submission, browser automation, AI calls, ad buying, or external execution.
